...
class PootleSocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def is_open_for_signup(self, request, sociallogin):
        ...
        # `is_open_for_signup()` is controlled by `settings.CAN_REGISTER`, and
        # we want to apply its semantics only to regular user accounts, not
        # social accounts. So social accounts can sign up for new user accounts
        # anytime.
